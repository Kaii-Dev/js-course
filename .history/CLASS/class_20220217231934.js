...
console.log(khai.name);
   ...
   //STATIC METHOD: không bị phụ thuộc bất kì obj nào mà khi sử dụng từ khóa new, mà nó sẽ gọi trực tiếp từ class !. dùng để thực hiện chức năng nào đó từ class mà không cần phải thông qua từ khóa new
   class