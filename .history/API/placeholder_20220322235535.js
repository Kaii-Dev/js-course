...
courseList.addEventListener("click", async function (e) {
  if (e.target.matches(".course-remove")) {
    ...
    formPost.elements["title"].value = data.titl;
    formPost.elements["author"].value = data.image;
    formPost.elements["rating"].value = data.image;
    formPost.elements["price"].value = data.image;
    formPost.elements["bestSeller"].value = data.image;
    formPost.elements["buyAmount"].value = data.image;
  }
});
