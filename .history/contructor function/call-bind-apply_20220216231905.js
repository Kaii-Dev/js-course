...
logToday('server ok!');
   ...
   sayHi.call(person, 'hello', 'world');

   //function.apply(object, [arg1, arg2, ...]) : y chang call nhưng apply phải truyền vào mảng
   sayHi.apply(person, ['hello', 'world']);
   ...
   // console.log(arr);
   const newArr = arr.concat(arr,arr2);
   console.log(arr);