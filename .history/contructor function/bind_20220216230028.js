...
button.addEventListener('click', teacher.fullName); // bind giúp ràng buộc this trong fullname trở về student. vì nếu chỉ có student.fullName thì thằng this nó sẽ tự hiểu là thuộc về dom button nên kết quả sẽ ra undefined.
teacher.getFullName();