...
button.addEventListener('click', teacher.fullName); // teacher.fullname là fn mà lúc này được gán cho method button khác thì this của teacher.fullname lại trỏ về button mà button.first
teacher.getFullName();