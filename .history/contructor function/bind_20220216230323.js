...
button.addEventListener('click', teacher.fullName.bind()); // teacher.fullname là fn mà lúc này được gán cho method button khác thì this của teacher.fullname lại trỏ về button mà button.firstName và button.lastName ko có nên là undefined
teacher.getFullName();